<?php
/**
 * Dear Featured Posts Widget display markup.
 *
...
if ( have_posts() ) :
	...
	if ( $grid = dear_grid_exists( $data['simple_grid'] ) ) {
		add_filter( 'post_class', "dear_grid_{$grid}" );
	}
	...
	if ( $grid ) {
		remove_filter( 'post_class', "dear_grid_{$grid}" );
	}
