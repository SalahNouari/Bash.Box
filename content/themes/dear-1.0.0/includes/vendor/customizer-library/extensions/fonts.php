...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'dear' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'dear' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'dear' ),
		'cyrillic'     => __( 'Cyrillic', 'dear' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'dear' ),
		'devanagari'   => __( 'Devanagari', 'dear' ),
		'greek'        => __( 'Greek', 'dear' ),
		'greek-ext'    => __( 'Greek Extended', 'dear' ),
		'khmer'        => __( 'Khmer', 'dear' ),
		'latin'        => __( 'Latin', 'dear' ),
		'latin-ext'    => __( 'Latin Extended', 'dear' ),
		'vietnamese'   => __( 'Vietnamese', 'dear' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'dear' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'dear' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'dear' ),
