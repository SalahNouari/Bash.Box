...
$search_header->add_element("Code", array(
"columns" => "22",
"margin_left" => "1",
"margin_right" => "0",
"margin_top" => "0",
"margin_bottom" => "0",
"id" => "module-1419826329282-1954",
"options" => array(
	"type" => "CodeModel",
	"view_class" => "CodeView",
	...
	"element_id" => "upfront-code_element-object-1419826329281-1590",
...
"row" => 5,
"sticky" => false,
"wrapper_id" => "wrapper-1419826409684-1023",
"new_line" => "true",
...
"options" => array(
	...
	"id_slug" => "plaintxt",
	"content" => "<h1 class=\"\" style=\"text-align: center;\"><span class=\"upfront_theme_color_0\">SEARCH CRITERIA</span></h1>",
...
"options" => array(
	...
	"pagination" => "numeric",
	"posts_list" => "",
	"post_parts" => array("title", "date_posted", "content", "read_more", "categories"),
	"enabled_post_parts" => array("date_posted", "title", "content", "read_more", "categories"),
...
"row" => 9,
"sticky" => false,
"wrapper_id" => "wrapper-1424334709666-1885",
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
		"edited" => false,
...
"row" => 12,
"sticky" => false,
"wrapper_id" => "wrapper-1424334709669-1863",
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
		"edited" => false,
...
"options" => array(
	...
	"element_id" => "button-object-1424331625009-1614",
...
"row" => 18,
"wrapper_id" => "wrapper-1424334709669-1758",
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
		"edited" => false,
