...
class Uf_luke_and_sara extends Upfront_ChildTheme {
    ...
    public function add_scripts() {
        wp_enqueue_script('snap.svg-min', get_stylesheet_directory_uri() . '/js/snap.svg-min.js', array('jquery'));
    }
