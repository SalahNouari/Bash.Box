...
"background_image" => "" . get_stylesheet_directory_uri() . "/images/single-page-testimonials/Testimonials-Bg.jpg",
...
"options" => array(
	...
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/single-page-testimonials/testimonial1.jpg",
	"image_title" => "",
	"alternative_text" => "",
	"when_clicked" => false,
	"image_link" => "",
...
"options" => array(
	...
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/single-page-testimonials/testimonial2.jpg",
	"image_title" => "",
	"alternative_text" => "",
	"when_clicked" => false,
	"image_link" => "",
...
"options" => array(
	...
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/single-page-testimonials/testimonial3.jpg",
	"image_title" => "",
	"alternative_text" => "",
	"when_clicked" => false,
	"image_link" => "",
