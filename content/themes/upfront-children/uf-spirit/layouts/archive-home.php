<?php
$region_15 = upfront_create_region(
			array(
"name" => "region-15",
"title" => "Region 15",
"type" => "wide",
...
"background_image" => "" . get_stylesheet_directory_uri() . "/images/archive-home/Homepage-Banner.jpg",
...
"wrapper_id" => "wrapper-1408439682498-1955",
"sticky" => false,
"new_line" => "true",
...
$region_15->add_element("PlainTxt", array(
"columns" => "9",
"margin_left" => "0",
"margin_right" => "0",
"margin_top" => "0",
...
"options" => array(
	...
	"element_id" => "upfront-code_element-object-1408626869472-1809",
	"code_selection_type" => "Create",
	"markup" => "<a class=\"banner-anchor\" href=\"#About\"></a>",
	"style" => "/* Your styles here */
.banner-anchor {
 display: block;
 width: 60px;
...
"options" => array(
	...
	"class" => "c24 upfront-image",
	"id_slug" => "image",
	"element_id" => "image-1408440367600-1543",
	"row" => 3,
...
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\" style=\"text-align: center;\">Sweet roll candy sesame snaps. Candy canes donut candy canes do: 300nut. Jelly-o tootsie roll pie unerdwear.com cheesecake biscuit toffee I love. Sugar plum I love sesame snap</p>",
	"type" => "PlainTxtModel",
...
"background_position_y" => "100",
"background_position_x" => "50",
"background_image" => "" . get_stylesheet_directory_uri() . "/images/archive-home/Homepage-Services-Bg.jpg",
...
"margin_top" => "0",
"margin_bottom" => "0",
"id" => "module-1408442628370-1227",
"rows" => 6,
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<h2 class=\"\" style=\"text-align: center;\">SERVICES</h2>",
	"type" => "PlainTxtModel",
...
"wrapper_id" => "wrapper-1408442634872-1479",
"sticky" => false,
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
...
"rows" => 6,
"options" => array(
	"src" => "" . get_stylesheet_directory_uri() . "/images/archive-home/wave-line-92x4-9876.png",
	"srcFull" => "" . get_stylesheet_directory_uri() . "/images/archive-home/wave-line.png",
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/archive-home/wave-line.png",
	"image_title" => "",
	"alternative_text" => "waved line",
	...
	"class" => "c24 upfront-image",
	"id_slug" => "image",
	"element_id" => "object-1408442639295-1051",
	"row" => 2,
	"theme_style" => "waved-line",
	"anchor" => ""
	),
"wrapper_id" => "wrapper-1408442646888-1897",
"sticky" => false,
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
...
"margin_top" => "2",
"margin_bottom" => "0",
"id" => "module-1408442656163-1606",
"rows" => 6,
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\" style=\"text-align: center;\">Cupcake ipsum dolor sit amet I love cake halvah tiramisu. Pudding fruitcake lollipop gummi bears caramels. Oat cake topping marshmallo</p>",
	"type" => "PlainTxtModel",
...
"wrapper_id" => "wrapper-1408442660597-1917",
"sticky" => false,
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
...
"background_type" => "image",
"nav_region" => "",
"background_color" => "rgba(253,249,246,1)",
"background_style" => "fixed",
...
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<h3 class=\"\"><span class=\"upfront_theme_colors upfront_theme_color_2\">WELLNESS COACHING CONSULTATIONS</span></h3>",
	"type" => "PlainTxtModel",
	"element_id" => "text-object-1408441791054-1023",
	"class" => "c24 upfront-plain_txt",
	"has_settings" => 1,
	"is_edited" => true,
	"row" => 3,
...
"margin_top" => "0",
"margin_bottom" => "0",
"id" => "module-1408442665716-1406",
"rows" => 6,
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\">What’s your wellness vision? How can you achieve vibrant health and wellness if you haven’t dedicated yourself to defining your own vision of wellness? Wellness Coaching Consultations start with an initial vision; a single declaration of the life you want to have, how you want to feel, and how you want to get there. <br><a href=\"" . get_site_url() . "/about/\" rel=\"entry\"></a></p>",
	"type" => "PlainTxtModel",
...
"background_type" => "image",
"nav_region" => "",
"background_color" => "rgba(244,248,249,1)",
"background_style" => "fixed",
"background_position_y" => "100",
"background_position_x" => "50",
"background_image" => "" . get_stylesheet_directory_uri() . "/images/archive-home/Homepage-Services-Bg1.jpg",
"background_image_ratio" => 0.25,
"background_repeat" => "no-repeat",
"background_position" => "50% 100%",
"breakpoint" => array(
...
"background_position_y" => "100",
"background_position_x" => "50",
"background_image" => "" . get_stylesheet_directory_uri() . "/images/archive-home/Homepage-Services-Bg2.jpg",
"background_image_ratio" => 0.25,
"background_repeat" => "no-repeat",
"background_position" => "50% 100%",
"breakpoint" => array(
...
"background_position_y" => "100",
"background_position_x" => "50",
"background_image" => "" . get_stylesheet_directory_uri() . "/images/archive-home/Homepage-Services-Bg3.jpg",
"background_image_ratio" => 0.25,
"background_repeat" => "no-repeat",
"background_position" => "50% 100%",
"breakpoint" => array(
...
"options" => array(
	...
	"type" => "ButtonModel",
	"view_class" => "ButtonView",
	"element_id" => "button-object-1424334750055-1396",
	"class" => "c24 upfront-button",
	"has_settings" => 1,
	"id_slug" => "button",
	"currentpreset" => "small-button",
...
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<h2 class=\"\" style=\"text-align: center;\">TESTIMONIALS</h2>",
	"type" => "PlainTxtModel",
...
$region_8->add_element("Uimage", array(
"columns" => "4",
"margin_left" => "10",
"margin_right" => "0",
"margin_top" => "0",
...
"options" => array(
	...
	"class" => "c24 upfront-image",
	"id_slug" => "image",
	"element_id" => "object-1408445106532-1553",
	"row" => 1,
	"theme_style" => "waved-line",
	"anchor" => ""
	),
...
"options" => array(
	...
	"image_title" => "",
	"alternative_text" => "Fiona Beuchampt",
	"when_clicked" => false,
	"image_link" => "",
	"include_image_caption" => false,
	"image_caption" => "My awesome image caption",
...
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\"><em>“Meg has trained and retrained herself to be an EXCEPTIONAL trainer for people like me. She can modify a session in seconds to enable me to train safely and thoroughly. She knows a myriad of ways to develop a particular part of the body...”</em></p><p class=\"\" style=\"text-align: right;\"><strong style=\"text-align: right;\">Fiona Beauchampt<br></strong><em style=\"text-align: right;\">Occupational Therapist at CPEC&nbsp;</em></p>",
	"type" => "PlainTxtModel",
...
"wrapper_id" => "wrapper-1409146803749-1559",
"sticky" => false,
"wrapper_breakpoint" => array(
	"tablet" => array(
		"col" => 9,
...
"wrapper_id" => "wrapper-1408454836978-1393",
"sticky" => false,
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
...
"options" => array(
	...
	"content" => "<p class=\"\"><em>“Meg has trained and retrained herself to be an EXCEPTIONAL trainer for people like me. She can modify a session in seconds to enable me to train safely and thoroughly. She knows a myriad of ways to develop a particular part of the body...”</em></p><p class=\"\" style=\"text-align: right;\"><strong style=\"text-align: right;\">Fiona Beauchampt<br></strong><em style=\"text-align: right;\">Occupational Therapist at CPEC&nbsp;</em></p>",
	"type" => "PlainTxtModel",
	"element_id" => "object-1408445421683-1666",
	"class" => "c24 upfront-plain_txt",
	"has_settings" => 1,
	"row" => 7,
	"is_edited" => true,
...
"wrapper_id" => "wrapper-1409146903808-1116",
"sticky" => false,
"wrapper_breakpoint" => array(
	"tablet" => array(
		"col" => 9,
...
"margin_top" => "11",
"margin_bottom" => "0",
"id" => "module-1408445663649-1130",
"rows" => 6,
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\" style=\"text-align: right;\"><a href=\"" . get_site_url() . "/testimonials/\" rel=\"entry\">Read More</a></p>",
	"type" => "PlainTxtModel",
	"element_id" => "text-object-1408445663648-1867",
	"class" => "c24 upfront-plain_txt",
	"has_settings" => 1,
	"is_edited" => true,
	"border_style" => "none",
...
"wrapper_id" => "wrapper-1408454949110-1697",
"sticky" => false,
"new_line" => "true",
"wrapper_breakpoint" => array(
	"tablet" => array(
...
"background_type" => "color",
"nav_region" => "",
"background_color" => "rgba(226,222,213,1)",
"breakpoint" => array(
	"custom-1408717728290" => array(
		"edited" => false
		),
...
"options" => array(
	...
	"element_id" => "upfront-code_element-object-1414741597474-1891",
	"code_selection_type" => "Create",
	"markup" => "<div class=\"gift-icon\"></div>",
	"style" => ".gift-icon:before {
 margin: 0 auto;
 position: relative;
 margin-top: -60px;
 content: \"\";
...
"margin_top" => "0",
"margin_bottom" => "0",
"id" => "module-1408446264003-1758",
"rows" => 6,
"options" => array(
	"view_class" => "PlainTxtView",
	"id_slug" => "plain_text",
	"content" => "<p class=\"\" style=\"text-align: center;\">
	A weekly serving of motivation, recipes &amp; <strong><span class=\"upfront_theme_colors upfront_theme_color_0\" data-redactor-tag=\"span\">FREE</span></strong> resources straight to your inbox!
</p>",
	"type" => "PlainTxtModel",
...
"options" => array(
	...
	"element_id" => "upfront-code_element-object-1408627328690-1432",
	"code_selection_type" => "Create",
