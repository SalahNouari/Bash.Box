...
define( 'CHILD_THEME_NAME', 'devStarter' );
...
return '<script>,<style>,<b>,<br>,<em><img>'; //add whatever tags you want to this string
}
...
// Editor Styles
add_editor_style('library/editor-style.css'); //Pulls from the child theme styles.css unless otherwise stated
...
function lad_change_mce_options($initArray) {
...
add_filter('tiny_mce_before_init', 'lad_change_mce_options');
