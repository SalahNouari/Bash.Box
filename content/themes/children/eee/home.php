...
function lad_home_genesis_meta() {
	...
	if ( is_active_sidebar( 'home-welcome' ) || is_active_sidebar( 'home-slider' ) || is_active_sidebar( 'home-bands' ) || is_active_sidebar( 'home-venue' ) ||  is_active_sidebar( 'home-left' ) || is_active_sidebar( 'home-middle' ) || is_active_sidebar( 'home-right' ) ) {
...
function agency_home_loop_helper() {
	...
	if ( is_active_sidebar( 'home-main' ) || is_active_sidebar( 'home-left' ) || is_active_sidebar( 'home-middle' ) || is_active_sidebar( 'home-right' ) ) {

		echo '<div id="home">';
			
			echo '<div class="home-main">';
			dynamic_sidebar( 'home-main' );
			echo '</div><!-- end .home-main -->';			
			
			echo '<div class="clear-line">';
