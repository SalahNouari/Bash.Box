<div class="wrap clientside-docs">
	...
	<div class="clientside-page-sidebar">
		<div class="clientside-widget clientside-widget-bordered">
			...
			<div class="inside">
				...
				<p>
					<a class="clientside-button-lined clientside-button-large clientside-button-w100p" href="http://frique.me/support/" title="http://frique.me/support/">Frique Support Page</a>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="clientside-page-content">
		...
		<p>
			Visit the <a href="http://frique.me/support/" title="http://frique.me/support/">Frique Support Page</a> to find support options from the author.
		</p>
