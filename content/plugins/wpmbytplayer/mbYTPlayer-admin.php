...
function mbYTPlayer_options_page() { 	// Output the options page
    ...
    <div id="donate" style="display: none">
        <div id="donateContent">
            <h2>mb.YTPlayer</h2>
            <p ><?php _e('If you like it and you are using it then you should consider a donation <br> (€15,00 or more) :-)', 'wpmbytplayer'); ?></p>
            ...
            <br>
            <br>
            <button onclick="donate()"><?php _e('I already donate', 'wpmbytplayer'); ?></button>
        </div>
    </div>
    ...
    <h2><?php _e('mb.YTPlayer Settings', 'wpmbytplayer'); ?></h2>
    <p><?php printf( __( 'You’re using mb.YTPlayer v. %s', 'mbYTPlayer' ), get_option('mbYTPlayer_version') ); ?> <?php _e('by', 'wpmbytplayer'); ?> <a href="http://pupunzi.com">Pupunzi</a>.</p>
    ...
    <div class="updated fade" style="position: relative;">
        <p style="line-height: 1.4em;"><?php _e('Thanks for downloading mb.YTPlayer!', 'wpmbytplayer'); ?></p>
        <p id="inlineDonate" style="position: relative; display:block;top:0;margin-right: -10px">
            <?php _e('If you like it and you are using it<br>then you should consider a donation (€15,00 or more) :-)', 'wpmbytplayer'); ?><br><br>
            ...
            <br><br><i><?php _e('If you donate, the start popup will nevermore display', 'wpmbytplayer'); ?>.</i><br><br>
        </p>
        <hr>
        <p><?php _e('Don’t forget to follow me on twitter', 'wpmbytplayer'); ?>: <a href="https://twitter.com/pupunzi">@pupunzi</a></p>
        <p><?php _e('Visit my site', 'wpmbytplayer'); ?>: <a href="http://pupunzi.com">http://pupunzi.com</a></p>
        <p><?php _e('Visit my blog', 'wpmbytplayer'); ?>: <a href="http://pupunzi.open-lab.com">http://pupunzi.open-lab.com</a></p>
        <p id="donateTxt">Paypal: <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=V6ZS8JPMZC446&lc=GB&item_name=mb%2eideas&item_number=MBIDEAS&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donateCC_LG_global%2egif%3aNonHosted" target="_blank"><?php _e('donate', 'wpmbytplayer'); ?></a></p>
    </div>
    ...
    <div class="highlight fade" style="padding: 10px; margin: 0">
        ...
        <form action="http://pupunzi.us6.list-manage2.com/subscribe/post?u=4346dc9633&amp;id=91a005172f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            <label for="mce-EMAIL" style="font-weight: bold"><?php _e('Subscribe to my mailing list<br>to stay in touch', 'wpmbytplayer'); ?>.</label>
            <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="<?php _e('your email address', 'wpmbytplayer'); ?>" required>
            <input type="submit" value="<?php _e('Subscribe', 'wpmbytplayer'); ?>" name="subscribe" id="mc-embedded-subscribe" class="button">
        </form>
        <!--End mc_embed_signup-->
    </div>
    ...
    <form id="optionsForm" method="post" action="options.php">
        ...
        <h2><?php _e('Reference', 'wpmbytplayer'); ?></h2>

        <p><?php _e('You can add a mb.YTPlayer to any of your posts via the shortcode editor available by clicking the button placed on the button-bar of the post content editor', 'wpmbytplayer'); ?></p>
        <br>
        <h2><?php _e('Home page background video properties', 'wpmbytplayer'); ?>:</h2>
        <p><?php _e('These settings are used only for the Home istance of the mb.YTPlayer component', 'wpmbytplayer'); ?>.</p>
        <br>
        <br>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to activate the background video for the Homepage or the blog index page', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Copy and paste here the URL of the Youtube video you want as your homepage background. Adding more then one URL comma separated it will be chosen one randomly each time you reach the page.', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Set the opacity of the background video', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Set the aspect-ratio of the background video. If "auto" the plug in will try to retrieve the aspect ratio from Youtube. If you have problems on viewing the background video try setting this manually.', 'wpmbytplayer'); ?>
                    </p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to show controls at the bottom of the page', 'wpmbytplayer'); ?>.</p>
                    <div id="videourl" style="display: none;">
                        ...
                        <p><?php _e('Check to show the link to the original YouTube® video', 'wpmbytplayer'); ?>.</p>
                    </div>
                    <script>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Full screen containment is the screen', 'wpmbytplayer'); ?></p>
                    ...
                    <p><?php _e('Full screen containment is the browser window', 'wpmbytplayer'); ?></p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to mute the audio of the video', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to loop the video once ended', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to add a raster effect to the video', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p><?php _e('Check to track this video on Google Analytics if played', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php _e('Pause the player if the windows blur:', 'wpmbytplayer'); ?></th>
                <td>
                    ...
                    <p><?php _e('Check to pause the player once the window blur', 'wpmbytplayer'); ?>.</p>
                </td>
            </tr>
