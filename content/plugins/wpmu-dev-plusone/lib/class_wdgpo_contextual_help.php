			...
			array(
				...
				array(
					...
					'content' => '' .
						'<p>' . __('Follow these steps to set up <em>My Google+ page ID</em> and <em>My Google+ profile ID</em> fields', 'wdgpo') . '</p>' .
						"<ol>" .
							"<li><a href='https://code.google.com/apis/console/'>" . __('Create a project in Google Developers Console', 'wdgpo') . '</a></li>' .
							'<li>' . __('Under &quot;APIS & AUTH » APIs&quot; tab, turn &quot;Google+ API&quot; to <b>ON</b>', 'wdgpo') . '</li>' .
							'<li>' . sprintf(__("Under &quot;APIS & AUTH » Credentials&quot; click &quot;Create new Client ID&quot;. Select &quot;Web application&quot; then fill in your details and use this as your &quot;Authorized Redirect URIs&quot;: <code>%s</code>", 'wdgpo'), esc_url($auth->get_redirect_url())) . '</li>' .
