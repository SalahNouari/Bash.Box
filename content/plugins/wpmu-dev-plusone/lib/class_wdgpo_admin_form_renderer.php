...
class Wdgpo_AdminFormRenderer {
	...
	function create_gplus_app_settings_box () {
		...
		echo "<ol>";
		echo "<li><a href='https://console.developers.google.com/project'>" . __('Create a project in Google Developers Console', 'wdgpo') . '</a></li>';
		echo '<li>' . __('Under &quot;APIS & AUTH » APIs&quot; tab, turn &quot;Google+ API&quot; to <b>ON</b>', 'wdgpo') . '</li>';
		echo '<li>' . sprintf(__("Under &quot;APIS & AUTH » Credentials&quot; click &quot;Create new Client ID&quot;. Select &quot;Web application&quot; then fill in your details and use this as your &quot;Authorized Redirect URIs&quot;: <code>%s</code>", 'wdgpo'), esc_url($auth->get_redirect_url())) . '</li>';
