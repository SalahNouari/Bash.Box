...
if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
  $defaultConfig = $Gplus_apiConfig;
  require_once (dirname(__FILE__)  . '/local_config.php');
  $Gplus_apiConfig = array_merge($defaultConfig, $Gplus_apiConfig);
}
...
class Google_Client {
  ...
  public function __construct($config = array()) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig = array_merge($Gplus_apiConfig, $config);
    self::$cache = new $Gplus_apiConfig['cacheClass']();
    self::$auth = new $Gplus_apiConfig['authClass']();
    self::$io = new $Gplus_apiConfig['ioClass']();
  }
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($Gplus_apiConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $Gplus_apiConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $Gplus_apiConfig;
    $Gplus_apiConfig['use_objects'] = $useObjects;
  }
